                    ...
                    <div class="row">
                        <div class="mb-3">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-success">{{ $datas->appointment_type == 2?$datas->passportnumber:$datas->number }}</li>
                            </ul>
                            <input type="hidden" name="order_id" value="{{ $datas->order_id }}">
                            <input type="hidden" name="number" value="{{ $datas->appointment_type == 2?$datas->passportnumber:$datas->number }}">
                    ...
                    <div class="row">
                        <div class="col-5 m-auto">
                            <div class="text-center avatar-profile position-relative py-4 border-bottom">
                                <img src="{{ Avatar::create($datas->passportname) }}" class="rounded-circle shadow-md avatar avatar-md-md" alt="">
                                ...
                                <div class="card-body">
                                    <div class="list-unstyled">
                                        ...
                                        <div class="d-flex align-items-center mt-2">
                                            ...
                                            <p class="text-muted mb-0 ms-2">{{ $datas->appointment_type == 2?$datas->passportnumber:$datas->number }}</p>
                                        </div>
