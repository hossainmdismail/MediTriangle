        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-bottom p-3">
                    <h5 class="modal-title" id="exampleModalLabel">Update Embassy</h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3 pt-4">
                    <form action="{{ route('embassy.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <x-Input type="text" label="Embassy Name" name="embassy"  placeholder="Dhaka/India"/>
                            </div>
            ...
            <div class="col-xl-9 col-lg-6 col-md-4">
                ...
                <nav aria-label="breadcrumb" class="d-inline-block mt-2">
                    <ul class="breadcrumb breadcrumb-muted bg-transparent rounded mb-0 p-0">
                        <li class="breadcrumb-item">Embassy</li><i style="font-size:12px;padding-left:6px" class="fa-solid fa-chevron-right"></i>
                        <li class="breadcrumb-item active" aria-current="page">Add Embassy</li>
                    </ul>
                </nav>
            </div><!--end col-->
                    ...
                    <form>
                        <div class="row justify-content-end align-items-center">
                            <div class="col-sm-12 col-md-7 mt-4 mt-sm-0">
                                <div class="d-grid">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#appointmentform">Add Embassy</a>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </form><!--end form-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end p-3">
                                        <a href="{{ $data->name }}" data-value="{{ route('embassy.edit',$data->id)}}" class="update_value btn btn-icon btn-pills btn-soft-success" data-bs-toggle="modal" data-bs-target="#update"><i class="fa-solid fa-pen-to-square"></i></a>

                                        <a href="{{ route('embassy.destroy',$data->id) }}" data-bs-toggle="modal" data-bs-target="#LoginFormTwo" class="delete_value btn btn-icon btn-pills btn-soft-danger"><i class="fa-solid fa-trash"></i></a>
