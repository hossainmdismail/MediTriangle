        ...
        <div class="col-md-6 m-auto my-5 ">
            <div class="card my-5">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <input style="background-color: #1ab8ae0f !important;" type="text" name="con_password" class="form-control py-3 border-0 @error('con_password') is-invalid @enderror" placeholder="Confirm Password">
                    </div>
