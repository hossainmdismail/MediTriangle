        ...
        <div class="row mt-5">
            <div class="col-md-6 mt-5 mb-5 m-auto">
                <div class="bg-light rounded p-5">
                    <h4 class="d-inline-block text-primary text-uppercase border-bottom border-5 border-white mb-4">Login</h4>
                    <form action="{{ route('access.login') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="number" name="number" class="form-control bg-white border-0" placeholder="01XXXXXXXXX" style="height: 55px;">
                            </div>
                            <div class="col-12">
